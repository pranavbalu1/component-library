...
export function ChartsShowcase() {
  const [activeTab, setActiveTab] = React.useState<"interactive" | "grid">("interactive")
  const [selectedScenario, setSelectedScenario] = React.useState<number>(0)

  const scenarios = [
    {
      title: "Personal Budgeting",
      description: "Subtle 4px bar rounding with color-matched dynamic totals and tooltips.",
      cornerRadius: 4,
    ...
    },
    {
      ...
      description: "Pill-style 12px rounded segments with emerald top total colors.",
      cornerRadius: 12,
    ...
    },
    {
      ...
      description: "Single segment bars with cyan-themed tooltips and column totals.",
      cornerRadius: 6,
