...
import { LayoutGrid, Navigation, List, Activity, BarChart2, Home, CreditCard } from 'lucide-react';
import { cn } from '@/lib/utils';

const showcases = [
  { path: '/components', label: 'Components', icon: LayoutGrid, component: ComponentShowcase },
  { path: '/navbars', label: 'Navbars', icon: Navigation, component: NavbarShowcase },
  { path: '/lists', label: 'Lists', icon: List, component: ListShowcase },
  { path: '/metrics', label: 'Metric Cards', icon: Activity, component: MetricCardShowcase },
  { path: '/charts', label: 'Charts', icon: BarChart2, component: ChartsShowcase },
  { path: '/cards', label: 'Card Deck', icon: CreditCard, component: CardListShowcase },
];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pt-8">
      <div className="space-y-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-white">Component Showcase</h1>
        <p className="text-zinc-400">Select a component library preview below to explore interactive demos.</p>
      </div>
      ...
      <aside className="w-full md:w-64 bg-zinc-950 border-r border-zinc-800/80 p-4 shrink-0 flex flex-col justify-between">
        <div className="space-y-6">
          <Link to="/" className="flex items-center gap-2 px-2 pt-2">
            ...
            <span className="font-bold text-lg text-white tracking-tight">Design System</span>
          </Link>
